...
export default function FundraiserSuccess() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-6 flex justify-center items-center">
      {/* 🎉 Confetti Effect */}
      <Confetti width={windowSize.width} height={windowSize.height} numberOfPieces={200} gravity={0.2} recycle={false} />
      ...
      <div className="w-full max-w-3xl bg-white shadow-lg rounded-xl p-8 text-center">
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-4">
          <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white flex items-center justify-center" onClick={() => router.push("/share-fundraiser")}>
            <Share2 className="w-5 h-5 mr-2" /> Share Fundraiser
          </Button>
          <Button className="w-full bg-green-500 hover:bg-green-600 text-white flex items-center justify-center" onClick={() => router.push("/view-fundraiser")}>
            <ArrowRight className="w-5 h-5 mr-2" /> View Fundraiser
          </Button>
          <Button className="w-full bg-purple-500 hover:bg-purple-600 text-white flex items-center justify-center" onClick={() => router.push("/create-fundraiser")}>
